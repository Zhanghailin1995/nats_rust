...
mod tests {
    ...
    fn million_messages_second_sample(seconds: i32) -> Sample {
    ...
    fn test_std_dev() {
        ...
        sg.add_sample(million_messages_second_sample(1));
        sg.add_sample(million_messages_second_sample(1));
        sg.add_sample(million_messages_second_sample(1));
    ...
    fn test_bench_setup() {
        ...
        bench.add_pub_sample(million_messages_second_sample(1));
        bench.add_sub_sample(million_messages_second_sample(1));
